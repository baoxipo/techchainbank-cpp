...
int main(){
    ...
    SetConsoleCP(65001);
    Blockchain blockchain(do_kho_mac_dinh);
    while(true){
        system("cls");
        in_banner();
        cout << "┌─────────────── TCBank ───────────────" << endl;
        ...
        if(c == '1') {
            ...
            while(true){
                ...
                if(z == '1'){
                    ...
                    string ten_nguoi_nhan = tim_ten_tu_so_tai_khoan(sotaikhoan2);
                    bool chuyen_thanh_cong = chuyen_khoan(taikhoan, sotaikhoan2, so_tien_muon_chuyen);
                    if(chuyen_thanh_cong){
                        blockchain.themGiaoDich(GiaoDich(
                            taikhoan.ten_nguoi_dung,
                            ten_nguoi_nhan,
                            "0000",
                            "0000",
                            so_tien_muon_chuyen,
